from model_ablation_ODA import Patient_DA_prediction
...
if __name__ == "__main__":
    ...
    for epoch in range(n_epochs):
        ...
        np.save(f"predictions/preds_ablation_ODA_test.npy", preds.cpu().numpy())
        np.save(f"predictions/targets_ablation_ODA_test.npy", targets.cpu().numpy())
        torch.save(model,f"models/ablation_ODA.pt")
