...
class Patient_DA_prediction(nn.Module):
    def __init__(self,config):
        ...
        self.da_prediction_head = nn.Linear(fusion_dim, fusion_dim)
        self.da_prediction_head2 = nn.Linear(fusion_dim, self.config.n_da_client)
...
"Backchannel"]
    ...
    def forward(self, past_value_da, past_time_features, past_observed_mask, static_categorical_features, future_values_da,future_time_features,text):
        ...
        outputs = self.model(
            ...
            #static_real_features=text_feature,
        ...
        out = self.da_prediction_head(out)
